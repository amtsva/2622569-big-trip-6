...
export default class PointView extends AbstractView {
  ...
  get template() {
    ...
    const favoriteClass = this.#point.isFavorite
    ...
    return `
      <li class="trip-events__item">
        <div class="event">
          <time class="event__date" datetime="${startDate.toISOString().split('T')[0]}">
            ${formattedDate}
          </time>
          ...
          <h3 class="event__title">
            ${this.#point.type} to ${this.#point.destination.name}
          </h3>
